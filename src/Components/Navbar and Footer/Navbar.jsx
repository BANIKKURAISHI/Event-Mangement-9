...
<NavLink to="/reg" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "bg-rose-700 p-2 mr-2 text-red text-xl  text-center rounded-md font-medium" : "p-2 mr-2 text-xl font-medium bg-red-600  text-center rounded-md"}>Registration</NavLink>
    ...
    <a className="normal-case font-bold text-rose-900 text-4xl my-6 text-center md:">Weeding planner</a>
  </div>
  ...
  <div className="navbar-end">
  {
    user?<div className="text-center md:text-end">
        ...
        <button className=" bg-red-600  text-white text-center rounded-md text-red text-xl font-medium md: px-3 ml-2  my-3  " onClick={logoutButton}>Logout</button>
        </div>
        </div>
